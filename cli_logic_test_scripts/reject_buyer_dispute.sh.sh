...
npx near call $NEARID update_client_dispute_request '{"order_id": "'$ORDERID'", "status":"reject"}' --account-id efama_marketplace.testnet


#withdraw funds for farmer since dispute was rejected
